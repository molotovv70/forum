        ...
        <div class="flex items-center mb-4">
            ...
            <template v-if="this.$page.props.auth.roles.some(code => {
                ...
                <Link :href="route('branches.themes.create', branch.id)"
                      class="block mr-4 px-2 py-1 w-1/6 bg-white border border-gray-300 rounded-lg text-center">+ Тема
                </Link>
            </template>
        </div>
        ...
        <div class="">
            ...
            <div v-for="theme in branch.themes" class="flex items-center">
                <Link :href="route('themes.show', theme.id)"
                      class="block bg-white border border-gray-300 p-4 w-full flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                ...
                return [
                    ...
                    <Link :href="route('themes.edit', theme.id)"
                          class="block bg-sky-500 p-4 border border-gray-100 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-6 h-6 stroke-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <Link :href="route('themes.destroy', theme.id)" :method="'delete'" as="button"
                          class="block bg-red-500 p-4 border border-gray-100 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="currentColor" class="w-6 h-6 stroke-white">
                            <path stroke-linecap="round" stroke-linejoin="round"
